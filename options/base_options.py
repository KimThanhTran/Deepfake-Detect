...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # GenImage-specific toggles
        parser.add_argument('--genimage_mode', action='store_true', help='use translate-duplicate instead of resize (GenImage evaluation/training)')
    ...
    def parse(self, print_options=True):
        ...
        # set gpu ids (fallback to CPU if CUDA not available)
