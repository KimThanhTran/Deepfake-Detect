...
from .adaptive_npr import AdaptiveNPR
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1, zero_init_residual=False, adaptive_npr=False):
        ...
        self.inplanes = 64
        self.adaptive_npr_enabled = adaptive_npr
        if self.adaptive_npr_enabled:
            self.npr = AdaptiveNPR(in_channels=3, scales=(2,4), kernel_size=3)
